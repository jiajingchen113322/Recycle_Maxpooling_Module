...
def get_parse():
    ...
    parser.add_argument('--model',default='dgcnn',choices=['dgcnn','pointnet','dpfa'])
    parser.add_argument('--seed',default=0)
    parser.add_argument('--cuda',default=0,type=int)
    parser.add_argument('--test_area',default=5,type=int)
    parser.add_argument('--exp_name',default='DGCNN_area6_ori',type=str)
...
def main():
    ...
    if cfg.model=='pointnet':
        model=PointNet_seg(inpt_dim=9,num_cls=13)
        ...
        model=DPFA(num_cls=13,inpt_length=9)
...
def test(model,data_loader,pth_folder):
    ...
    target_pth_path=os.path.join(pth_file,'epoch_86')
